...
ui <- fluidPage(
  ...
  selectInput("x", 
              ...
              choices = sort(unique(gestation$order)), #order in alphabetical order
  ...
  output$plot <- renderPlot({
    ...
    gestation %>% 
      ...
      geom_density(fill="steelblue",
                   color="black",
                   alpha=0.6)+
      labs(title="Density Distribution by Mammalian Order")+
      theme_minimal()
  })
}
...
ui <- dashboardPage(
  ...
  dashboardHeader(title="Sex Composition of Wolf Pack"),
