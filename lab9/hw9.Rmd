...
The data is tidy as each variable has its own column but it's just in the long format. 
...
```{r}
avg_entercocci_year_wide <- avg_enterococci_year %>% 
  pivot_wider(
    names_from = "year",
...
In 2013, the most polluted beach was the Malabar Beach with enterococci counts of 320.
...
It seems that December has the highest average enterococci levels, which means it's the riskiest month overall to visit these beaches!
